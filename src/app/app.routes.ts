...
import { ComponentTemplateDrivenFormsComponent } from './components/component-template-driven-forms/component-template-driven-forms.component';
...
export const routes: Routes = [
    ...
    {path: 'template-driven-form', component: ComponentTemplateDrivenFormsComponent},
    ...
    {path: 'restricted-content-example', component:RestrictedContentExampleComponent, canActivate:
    [authGuard]},
